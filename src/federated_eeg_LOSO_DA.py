...
if __name__ == '__main__':
    ...
    args.store_name = '_'.join(
        ["LOSO_DA_", args.dataset, args.model, args.type, args.mixup_strategy, 'a-' + str(args.mixup_alpha), args.mixup_subtype, 'lr-' + str(args.lr)])
    ...
    for target_id in range(1, subject_num+1):
